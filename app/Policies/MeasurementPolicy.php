...
class MeasurementPolicy
{
    ...
    {
        return true; // المستخدم يمكنه رؤية مقاساته
    }
    ...
    {
        // المستخدم يمكنه رؤية مقاساته فقط
    ...
    {
        return true; // أي مستخدم مسجل يمكنه إنشاء مقاسات
    }
    ...
    {
        // المستخدم يمكنه تحديث مقاساته فقط
        return $user->id === $measurement->user_id;
    }
    ...
    {
        // المستخدم يمكنه حذف مقاساته فقط
        return $user->id === $measurement->user_id;
    }
