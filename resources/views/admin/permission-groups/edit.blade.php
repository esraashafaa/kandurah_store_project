...
@section('title', __('admin.permission_groups.edit_title'))
...
<nav class="flex mb-6" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                <i class="fas fa-chevron-left text-gray-400 mx-2"></i>
                <span class="text-gray-500">{{ __('admin.permission_groups.edit_title') }}</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">{{ __('admin.permission_groups.edit_title') }}</h1>
        <p class="text-gray-600 mt-1">{{ __('admin.permission_groups.edit_subtitle') }}</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           id="name_ar" 
                           name="name_ar" 
                           value="{{ old('name_ar', $permissionGroup->name['ar'] ?? '') }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="name_en" 
                           name="name_en" 
                           value="{{ old('name_en', $permissionGroup->name['en'] ?? '') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <textarea id="description_ar" 
                              ...
                              placeholder="وصف المجموعة بالعربية">{{ old('description_ar', $permissionGroup->description['ar'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="description_en" 
                              ...
                              placeholder="Group description in English">{{ old('description_en', $permissionGroup->description['en'] ?? '') }}</textarea>
            ...
            <div>
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" 
                           name="is_active" 
                           value="1"
                           {{ old('is_active', $permissionGroup->is_active) ? 'checked' : '' }}
                           class="sr-only peer">
