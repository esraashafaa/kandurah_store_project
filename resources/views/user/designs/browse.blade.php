...
@section('title', 'تصفح التصاميم')

@section('content')

<!-- Page Header -->
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">تصفح التصاميم</h1>
    <p class="text-gray-600 mt-1">استكشف تصاميم المستخدمين الآخرين</p>
</div>
...
<div class="bg-white rounded-xl shadow-sm p-6 mb-6">
    <form method="GET" action="{{ route('designs.browse') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">خيار التصميم</label>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
    ...
    <div class="col-span-full">
        <div class="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <p class="text-gray-600">لم يتم العثور على أي تصاميم تطابق معايير البحث</p>
        </div>
    </div>
    @endforelse
</div>
